...
namespace be {
	...
	MainPlatformWindowRenderer::MainPlatformWindowRenderer(int width, int height)
	{
		...
		m_shaders.SetVertexShaderPath("../../../../vstmr/assets/shaders/quad_vertex_shader.glsl");
		m_shaders.SetFragmentShaderPath("../../../../vstmr/assets/shaders/quad_fragment_shader.glsl");
