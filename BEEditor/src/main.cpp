...
namespace vstm {
    ...
    private:
        ...
        void ProcessMouseMovement()
        {
            ...
            if (ImGui::IsMouseDown(ImGuiMouseButton_Right) && ImGui::IsKeyDown(ImGuiKey_Q))
            {
    ...
    public:
        void Start()
        {
            ...
            ModelLoader::Load("../../../../BadEngineCore/Resources/models/ukulele.obj", meshRenderer, m_tm);
            meshRenderer.material.textures[0] = Texture{
                "C:\\Dev\\BadEngine\\BadEngineCore\\Resources\\Textures\\wood.png"
                };
    ...
    public:
        void Start()
        {
            ...
            MeshRenderer& meshRenderer = Add<MeshRenderer>();
            meshRenderer.material.color = { 1.0f, 1.0f, 0.0f };
            ModelLoader::Load("../../../../BadEngineCore/Resources/models/33-fbx/fbx/wolf.fbx", meshRenderer, m_tm);
            for (MeshComponent& mesh : meshRenderer.meshes)
            {
                mesh.SetupMesh();
            }
    ...
    public:
        void Start()
        {
            ...
            MeshRenderer& meshRenderer = Add<MeshRenderer>();
            meshRenderer.material.color = { 1.0f, 1.0f, 0.0f };
            ModelLoader::Load("../../../../BadEngineCore/Resources/models/cube.obj", meshRenderer, m_tm);
